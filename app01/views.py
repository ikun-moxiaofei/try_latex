...
from app01.serializers import QuestionSerializer
...
class ProblemList(APIView):
    def get(self, request, format=None):
        ...
        #     data['text'] = QuestionSerializer(data['text'])
...
class ProblemDetail(APIView):
    ...
    def get(self, request, pk):
        ...
        serializer = QuestionSerializer(problem)
    ...
    def put(self, request, pk, format=None):
        ...
        # 使用问题模型的序列化器处理传入的数据
        serializer = QuestionSerializer(problem, data=request.data)
